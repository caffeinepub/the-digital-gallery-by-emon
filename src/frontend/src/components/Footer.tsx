...
export default function Footer() {
  ...
  const hasBgImage = !!settings.footerBgImage;
  ...
  return (
    <footer
      ...
      style={{
        ...
        ...(hasBgImage
          ? {
              backgroundImage: `url(${settings.footerBgImage})`,
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-6 pt-4 pb-6">
            ...
            <div>
              <div className="flex items-center gap-3 mb-3">
                ...
                <span
                  ...
                  style={{ color: hasBgImage ? "#fff" : "black" }}
                >
                  The Digital Gallery
                  <br />
                  <span
          ...
          {/* Divider */}
          <div
            className="border-t mt-8 pt-5 flex flex-col sm:flex-row items-center justify-between gap-2"
            style={{
              borderColor: hasBgImage
          ...
          >
            <p
              ...
              style={{
                color: hasBgImage ? "rgba(255,255,255,0.7)" : "rgba(0,0,0,0.7)",
              }}
            >
            ...
            <a
              ...
              style={{
                color: hasBgImage ? "rgba(255,255,255,0.4)" : "rgba(0,0,0,0.4)",
              }}
            >
        ...
        {/* Animated SVG wave at footer bottom */}
        <div className="overflow-hidden leading-none" style={{ height: 56 }}>
          <svg
            viewBox="0 0 1200 56"
            preserveAspectRatio="none"
          ...
          >
            <defs>
              <style>{`
                ...
                .wave-layer-1 { animation: waveSlide1 12s linear infinite; }
                .wave-layer-2 { animation: waveSlide2 16s linear infinite; }
              `}</style>
            </defs>
            {/* Layer 1 */}
            <g className="wave-layer-1">
              <path
                d="M0,28 C150,48 300,8 450,28 C600,48 750,8 900,28 C1050,48 1200,8 1350,28 C1500,48 1650,8 1800,28 C1950,48 2100,8 2250,28 L2250,56 L0,56 Z"
            ...
            <g className="wave-layer-2">
              <path
                d="M0,36 C200,16 400,52 600,36 C800,16 1000,52 1200,36 C1400,16 1600,52 1800,36 C2000,16 2200,52 2400,36 L2400,56 L0,56 Z"
